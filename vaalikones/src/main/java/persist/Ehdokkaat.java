...
@NamedQueries({
    ...
    @NamedQuery(name = "Ehdokkaat.findByUsername", query = "SELECT e FROM Ehdokkaat e WHERE e.username = :username"),
    @NamedQuery(name = "Ehdokkaat.findByPassword", query = "SELECT e FROM Ehdokkaat e WHERE e.password = :password"),
    @NamedQuery(name = "Ehdokkaat.login", query = "SELECT e FROM Ehdokkaat e WHERE e.username = :username AND e.password = :password "),
